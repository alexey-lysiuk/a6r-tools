...
def _is_litevna64(hw_version: tuple[int, int], fw_version: tuple[int, int]) -> bool:
    return hw_version == (_EXPECTED_HW_MAJOR, _EXPECTED_HW_MINOR) and fw_version == (_EXPECTED_FW_MAJOR, _EXPECTED_FW_MINOR)
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--receiver-timeout', type=float, default=30.0, help='timeout waiting for XMODEM receiver start, defaults to 30')
