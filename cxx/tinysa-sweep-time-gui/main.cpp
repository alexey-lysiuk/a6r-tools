...
static LRESULT WINAPI WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_GETMINMAXINFO:
        reinterpret_cast<MINMAXINFO*>(lParam)->ptMinTrackSize = { 520, 360 };
        return 0;
    case WM_SYSCOMMAND:
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L,
                       ...
                       L"tinySA Sweep Time GUI", nullptr };
    ::RegisterClassExW(&wc);

    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"tinySA Ultra Sweep Time Calculator",
                                WS_OVERLAPPEDWINDOW,
...
int main(int argc, char* argv[])
{
    ...
    SDL_Window* window = SDL_CreateWindow(
        "tinySA Ultra Sweep Time Calculator",
        SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
        760, 420, window_flags);
    if (!window)
    {
    ...
    SDL_SetWindowMinimumSize(window, 520, 360);
